<template>
  <div id="app" class="container">
    ...
    <footer class="container-fluid footer text-left mt-3">
      <p class="mr-auto">
        Developed by:
        <strong>Odemilin Eromosele</strong>
      </p>
      <div style="float: right">
        <a href="mailto:goodluckodemilin@gmail.com" style="margin-right: 10px">
          <i
        ...
        <a
          href="https://github.com/striker1101"
          target="_blank"
        ...
        <a
          href="http://linkedin.com/in/eromosele-odemilin-2033aa242/"
          target="_blank"
          style="margin-right: 10px"
        >
          <i
