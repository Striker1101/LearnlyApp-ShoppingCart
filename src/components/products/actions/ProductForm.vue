              ...
              <div class="row">
                ...
                <div class="col">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="productRating" name="productRating" placeholder="Rating" v-model="product.productRating">
                  </div>
                </div>
                 <div class="col">
                  <div class="form-group">
                    <label for="productPrice">product Price</label>
                    <input type="number" class="form-control" id="productPrice" name="productPrice" placeholder="product Price" v-model="product.productPrice">
                  </div>
                </div>
              </div>
              <div class="form-group">
               ...
               <div class="form-group">
                ...
                <textarea class="form-control" id="productDescription" v-model="product.productDescription" placeholder="Tell us about the product"></textarea>
              </div>
              <br>
